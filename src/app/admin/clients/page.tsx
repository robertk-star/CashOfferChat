  ...
  return (
    <main className="min-h-screen bg-slate-50">
      <header className="border-b border-slate-200 bg-white">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-5">
          <div>
            ...
            <h1 className="mt-2 text-2xl font-bold text-navy">Client Users</h1>
            <p className="text-sm text-slate-500">Create login accounts for business clients.</p>
          </div>
      ...
      <section className="mx-auto max-w-7xl px-6 py-8">
        {params.saved && <div className="mb-6 rounded-2xl bg-green-50 p-4 text-sm text-green-800">Client user saved.</div>}
        ...
        <div className="mb-8 rounded-[2rem] bg-white p-6 shadow-soft ring-1 ring-slate-200">
          ...
          <form action="/api/admin/clients" method="post" className="mt-6 grid gap-4 md:grid-cols-2">
            ...
            <label className="block text-sm font-semibold text-slate-700">
              Name
              <input name="name" className="mt-1 w-full rounded-xl border border-slate-300 px-4 py-3" />
            </label>

            <label className="block text-sm font-semibold text-slate-700">
              Email
              <input name="email" type="email" required className="mt-1 w-full rounded-xl border border-slate-300 px-4 py-3" />
            </label>
