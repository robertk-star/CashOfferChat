        ...
        <form action="/api/admin/onboarding" method="post" className="space-y-8">
          <div className="rounded-[2rem] bg-white p-6 shadow-soft ring-1 ring-slate-200">
            ...
            <div className="mt-6 grid gap-4 md:grid-cols-2">
              ...
              <label className="block text-sm font-semibold text-slate-700">Plan<select name="plan_name" defaultValue="starter" className="mt-1 w-full rounded-xl border border-slate-300 px-4 py-3"><option value="starter">Starter — $49/mo, 1 site</option><option value="pro">Pro — $99/mo, up to 4 sites/accounts</option></select></label>
