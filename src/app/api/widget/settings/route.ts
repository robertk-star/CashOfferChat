...
function defaultSettings(siteId: string) {
  return {
    ...
    widgetWelcomeMessage: "Hi! I can answer questions about selling a house as-is for cash. If you want a property review, use the quote button and enter the house details.",
