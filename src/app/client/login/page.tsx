    ...
    <main className="flex min-h-screen items-center justify-center bg-slate-50 px-6">
      <div className="w-full max-w-md rounded-[2rem] bg-white p-8 shadow-soft ring-1 ring-slate-200">
        <p className="mb-4 inline-flex rounded-full bg-amber-50 px-4 py-2 text-sm font-semibold text-amber-800">
          CashOfferChat Client Portal
        </p>
        <h1 className="text-3xl font-bold text-navy">Client Login</h1>
        <p className="mt-3 text-sm text-slate-600">
          Log in to view leads and widget activity for your business.
        </p>
        ...
        <form action="/api/client/login" method="post" className="mt-6 space-y-4">
          ...
          <button className="w-full rounded-full bg-navy px-5 py-3 font-bold text-white" type="submit">
            Log In
          </button>
        </form>
      </div>
