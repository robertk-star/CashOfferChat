...
export async function GET(request: Request) {
  ...
  let query = supabase
    .from("seller_leads")
    .select(
      "created_at, status, name, phone, email, property_address, property_city, situation, timeline, property_condition, notes, admin_notes, source_url, site_id, business_id"
    )
