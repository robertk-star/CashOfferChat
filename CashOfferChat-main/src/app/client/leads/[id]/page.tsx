      ...
      <section className="mx-auto grid max-w-7xl gap-6 px-6 py-8 lg:grid-cols-[1fr_.9fr]">
        <div className="space-y-6">
          ...
          <div className="rounded-[2rem] bg-white p-6 shadow-soft ring-1 ring-slate-200">
            ...
            <dl className="mt-6 grid gap-4 md:grid-cols-2">
              {[
                ...
                ["Last Contacted", lead.last_contacted_at ? new Date(lead.last_contacted_at).toLocaleString() : ""],
              ].map(([label, value]) => (
          ...
          <div className="rounded-[2rem] border border-red-200 bg-white p-6 shadow-soft">
            ...
            <form action={`/api/client/leads/${lead.id}`} method="post" className="mt-5 space-y-4">
          ...
          <div className="rounded-[2rem] bg-white p-6 shadow-soft ring-1 ring-slate-200">
            ...
            <form action={`/api/client/leads/${lead.id}`} method="post" className="mt-6 space-y-4">
              <label className="block text-sm font-semibold text-slate-700">
                Status
